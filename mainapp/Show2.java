...
public class Show2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show2activity);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://groundwaterbkj.000webhostapp.com/appgw/listSemunope.php",
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            case R.id.item1:
                startActivity(new Intent(Show2.this, Show1.class));
                break;


            case R.id.item2:
                startActivity(new Intent(Show2.this, Show2.class));
                break;
